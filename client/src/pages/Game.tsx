...
import StopGame from "../components/stop/StopGame";
...
export default function Game() {
  ...
  const isStop = state.selectedGame === "stop";
  const compactLayout = isFourColors || isPoker || isStop;
  ...
  return (
    ...
    >
      ...
      >
        <div className={compactLayout ? "four-colors-main min-h-0 min-w-0" : "min-w-0"}>
          {error && (
